...
const artigos = [
  ...
  },
  {
    ...
    descricao: "Portar lockpick, C4, chipe hacker, utilizados para práticas ilegais. O indivíduo deve possuir abaixo de 10 itens ilegais no bolso na hora da apreensão.",
    pena: 0,
    multa: 3000,
    fianca: 0
  },
  ...
  },
  {
    ...
    multa: 2500,
    fianca: 3000,
    observacao: "Postar em redes fatos ofensivos que prejudiquem a reputação de alguém."
  },
  {
    numero: 29,
    categoria: "Honra",
    ...
    multa: 2500,
    fianca: 3700,
    observacao: "Ofender a dignidade ou o decoro de outra pessoa."
  },
  {
    numero: 30,
    categoria: "Honra",
    ...
    multa: 3500,
    fianca: 4500,
    observacao: "Acusar falsamente alguém da prática de crime."
  },
  {
    numero: 31,
    categoria: "Honra",
    ...
    multa: 3500,
    fianca: 3800,
    observacao: "Utilizar imagem de terceiros sem autorização, salvo em investigações policiais."
  },
  {
    numero: 32,
    categoria: "Drogas",
  ...
  },
  {
    ...
    descricao: "Comercializar lockpick, C4, chipe hacker, masterpick, órgãos humanos ou outros materiais utilizados para práticas ilegais. O indivíduo deve possuir acima de 10 itens ilegais no bolso na hora da apreensão.",
    pena: 10,
    multa: 4000,
    fianca: 4800
  },
  {
    ...
    multa: 1500,
    fianca: 2000,
    observacao: "Não havendo dúvidas da utilização para fabricação de material ilegal. Ex.: corpo de rifle, pólvora, projetos de arma e munição."
  },
  {
    numero: 45,
    categoria: "Ordem Pública",
  ...
  },
  {
    ...
    multa: 2500,
    fianca: 4500,
    observacao: "Servidor público que excede seus poderes ou usa o cargo de forma ilegal."
  },
  {
    numero: 55,
    categoria: "Administração Pública",
  ...
  },
  {
    ...
    multa: 5500,
    fianca: 5800,
    observacao: "Solicitar ou receber vantagem indevida em razão do cargo público."
  },
  {
    numero: 57,
  ...
  },
  {
    ...
    multa: 25000,
    fianca: null,
    observacao: "Entrar em dependências policiais sem autorização."
  },
  {
    numero: 63,
    categoria: "Patrimônio",
  ...
  },
  {
    ...
    descricao: "Quando 4 (quatro) ou mais pessoas forem detidas na mesma ocorrência e os envolvidos atuarem juntos, especialmente se estiverem identificados como grupo (uniformizados) ou forem detidos no mesmo contexto criminoso.",
    pena: 30,
    multa: 10000,
    fianca: 12000,
  ...
  },
  {
    ...
    descricao: "Associação a uma organização com fins ilegais com utilização qualquer tipo de identificação.",
    pena: 15,
    multa: 5000,
    fianca: 6500
  },
  ...
  },
  {
    ...
    descricao: "Descumprir normas ou ordens militares de baixa gravidade.",
    pena: 50,
    multa: 0,
    fianca: 0
  },
  {
    ...
    descricao: "Violar normas ou diretrizes militares de média gravidade, comprometendo a ordem institucional.",
    pena: 75,
    multa: 0,
    fianca: 0
  },
  {
    ...
    descricao: "Cometer infrações graves contra a hierarquia, disciplina ou segurança militar.",
    pena: 130,
    multa: 0,
    fianca: 0
  },
...
function pesquisarArtigos() {
  ...
  const filtrados = artigos.filter((artigo) =>
    ...
    normalizarTexto(artigo.observacao || "").includes(termo)
  );
    ...
    <div class="document-body">
      ...
      <section class="result-values-panel">
        ...
        <div class="result-value-row">
          ...
          <strong>R$ ${formatarMoeda(honorarios)}</strong>
        </div>
